 ...
 * motor lo escribe. Claude no toca Supabase ni busca en la web aqui (estos tres
 * pasos son transformacion pura del input; el research vive solo en el analisis).
 *
